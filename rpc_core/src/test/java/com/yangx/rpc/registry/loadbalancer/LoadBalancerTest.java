package com.yangx.rpc.registry.loadbalancer;

import com.yangx.rpc.loadbalancer.ConsistentHashLoadBalancer;
import com.yangx.rpc.loadbalancer.LoadBalancer;

import com.yangx.rpc.loadbalancer.RandomLoadBalancer;
import com.yangx.rpc.loadbalancer.RoundRobinLoadBalancer;
...
public class LoadBalancerTest {
    ...
    public void select() {
        ...
        serviceMetaInfo2.setServiceHost("Black Myth: WuKong");
